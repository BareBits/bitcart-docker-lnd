...
BTCLND_NETWORK=$BTCLND_NETWORK
BTCLND_DEBUG=$BTCLND_DEBUG
BTCLND_TOR=$BTCLND_TOR
...
BTCLND_BASE_P2P_PORT=$BTCLND_BASE_P2P_PORT
BTCLND_P2P_PORT_RANGE_END=$BTCLND_P2P_PORT_RANGE_END
BTCLND_BASE_GRPC_PORT=$BTCLND_BASE_GRPC_PORT
BTCLND_GRPC_PORT_RANGE_END=$BTCLND_GRPC_PORT_RANGE_END
BTCLND_GRPC_PUBLIC_HOST=$BTCLND_GRPC_PUBLIC_HOST
